...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Bulan Mei 2023 pada 17.34
...
--
-- Struktur dari tabel `customergojek`
--

CREATE TABLE `customergojek` (
  `id_cust` decimal(10,2) NOT NULL,
  `nama_cust` varchar(70) NOT NULL,
...
--
-- Struktur dari tabel `drivergojek`
--

CREATE TABLE `drivergojek` (
  `id_driv` decimal(10,2) NOT NULL,
  `nama_driv` varchar(70) NOT NULL,
  `notelp_driv` decimal(10,2) NOT NULL,
  `kendaraan` varchar(50) NOT NULL,
  `platKen` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Struktur dari tabel `ordergojek`
--

CREATE TABLE `ordergojek` (
  `id_order` decimal(10,2) NOT NULL,
  `id_cust` decimal(10,2) NOT NULL,
  `id_driv` decimal(10,2) NOT NULL,
  `tgl_order` varchar(70) NOT NULL,
  `total_pay` decimal(10,2) NOT NULL,
  `jenis_pay` varchar(70) NOT NULL,
  `lokasi_awal` varchar(70) NOT NULL,
  `lokasi_tujuan` varchar(70) NOT NULL,
  `jarak` varchar(70) NOT NULL,
  `waktu_perjalanan` varchar(70) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `products` (
  ...
  `buyPrice` varchar(1000) NOT NULL,
...
--
-- Struktur dari tabel `products_copu`
--

CREATE TABLE `products_copu` (
  `productCode` varchar(15) NOT NULL,
  `productName` varchar(70) NOT NULL,
  `productLine` varchar(50) NOT NULL,
  `productScale` varchar(10) NOT NULL,
...
--
-- Struktur dari tabel `products_copy`
--
...
--
-- Dumping data untuk tabel `products_copy`
--
...
--
-- Indeks untuk tabel `customergojek`
--
ALTER TABLE `customergojek`
...
--
-- Indeks untuk tabel `customers_copy`
--
ALTER TABLE `customers_copy`
  ADD PRIMARY KEY (`customerNumber`);

--
-- Indeks untuk tabel `drivergojek`
--
ALTER TABLE `drivergojek`
  ADD PRIMARY KEY (`id_driv`),
...
--
-- Indeks untuk tabel `ordergojek`
--
ALTER TABLE `ordergojek`
...
--
-- Ketidakleluasaan untuk tabel `ordergojek`
--
ALTER TABLE `ordergojek`
  ADD CONSTRAINT `id_cust` FOREIGN KEY (`id_cust`) REFERENCES `customergojek` (`id_cust`),
  ADD CONSTRAINT `id_driv` FOREIGN KEY (`id_driv`) REFERENCES `drivergojek` (`id_driv`);
